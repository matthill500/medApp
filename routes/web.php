...
Route::get('/admin/doctors/{id}/show', 'Admin\DoctorController@show')->name('admin.doctors.show');
...
Route::get('/admin/patients/{id}/show', 'Admin\PatientController@show')->name('admin.patients.show');
...
Route::get('/admin/visits/{id}/show', 'Admin\VisitController@show')->name('admin.visits.show');
